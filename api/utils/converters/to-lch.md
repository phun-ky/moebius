...
> Last updated 2025-05-12T08:46:27.937Z
...
```ts
function toLCH(color): MoebiusLCHObjectType;
```

Defined in: [utils/converters/to-lch.ts:18](https://github.com/phun-ky/moebius/blob/main/src/utils/converters/to-lch.ts#L18)
